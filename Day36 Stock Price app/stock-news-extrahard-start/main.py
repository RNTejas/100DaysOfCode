...
STOCK_API_KEY = 'C8G6MM0KMJ7DCRMK'    # alfavantage.co
NEWS_API_KEY = 'ab0ee07a9d694229ba7fab4a99cfac18'    # https://newsapi.org/

## STEP 1: Use https://www.alphavantage.co
# When STOCK price increase/decreases by 5% between yesterday and the day before yesterday then prfloat("Get News").
parameter = {
